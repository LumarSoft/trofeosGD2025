...
export default function AdminProductForm({ product, onSave, onCancel }: AdminProductFormProps) {
  ...
  return (
    ...
    >
      <h2 className="text-xl font-bold text-gold mb-6">{product ? "Editar Producto" : "Nuevo Producto"}</h2>
          ...
          <div className="md:col-span-1">
            <div className="flex flex-col items-center space-y-4">
              <div className="relative h-48 w-full rounded-lg overflow-hidden border border-gold/30">
                <Image src={formData.image || "/placeholder.svg"} alt="Product preview" fill className="object-cover" />
              </div>
              <Button
                type="button"
                variant="outline"
